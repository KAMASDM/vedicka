...
export default function Blog() {
    ...
    const fetchBlogs = async () => {
      try {
        const response = await ajaxCall(
          "/all-posts/?site_domain=vedicka.com",
          {
            method: "GET",
          }
        );
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await ajaxCall(
          "/get-categories/?site=vedicka.com",
          {
            method: "GET",
          }
        );
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 relative h-64 md:h-auto">
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      className="px-3 py-1 rounded-full bg-white/90 text-amber-600 text-sm font-medium"
                ...
                <div className="md:w-1/2 p-6 md:p-8 bg-white flex flex-col">
                  <h2
                    itemProp="headline"
                    className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 hover:text-amber-600"
                  >
                    {featuredBlog.title}
                  </h2>
                  <p
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {featuredBlog.tags.slice(0, 3).map((tag, index) => (
                      <Link
                        key={index}
                        href={`/tag/${tag.slug}`}
                        className="inline-flex items-center gap-1 px-2 py-1 rounded-full border-2 border-amber-100 bg-amber-100 text-amber-600 text-sm"
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="inline-flex items-center gap-1 px-4 py-2 bg-amber-100 rounded-full text-amber-600 text-sm font-medium hover:bg-amber-200 transition-colors">
                        Read Article{" "}
                        <ChevronRight
