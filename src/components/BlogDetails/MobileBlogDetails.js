...
const MobileBlogDetails = ({ slug }) => {
  ...
  return (
    <main className="pt-12 min-h-screen bg-gradient-to-r from-amber-50/30 to-amber-50/30">
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8 space-y-8">
            ...
            <motion.article
              ...
              className="prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 max-w-none bg-gradient-to-br from-amber-50 to-amber-50 rounded-xl p-6 shadow-md"
...
export default MobileBlogDetails;
