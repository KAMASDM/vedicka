  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        <Sparkles className="h-6 w-6 text-amber-600 mr-3" aria-hidden="true" />
        <h2
          ...
          >
            ...
            >
              ...
              <div className="p-4 h-full flex flex-col">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 hover:text-amber-600 transition-colors">
                  {relatedBlog.title}
                </h3>
                {relatedBlog.excerpt && (
